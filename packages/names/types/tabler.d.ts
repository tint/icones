...
// tabler: 5773 canonical icon names.
...
export type IconName =
  ...
  | "tabler:adjustments-horizontal-filled"
  ...
  | "tabler:details"
  | "tabler:details-off"
  | "tabler:device-3d-camera"
  | "tabler:device-3d-lens"
  ...
  | "tabler:device-computer-camera-2"
  ...
  | "tabler:device-floppy-filled"
  | "tabler:device-gamepad"
  | "tabler:device-gamepad-2"
  | "tabler:device-gamepad-2-filled"
  ...
  | "tabler:dots-vertical-filled"
  | "tabler:download"
  | "tabler:download-filled"
  | "tabler:download-off"
  | "tabler:drag-drop"
  | "tabler:drag-drop-2"
  | "tabler:dragon"
  ...
  | "tabler:git-pull-request-conflict"
  ...
  | "tabler:list"
  | "tabler:list-check"
  | "tabler:list-check-filled"
  | "tabler:list-details"
  | "tabler:list-details-filled"
  | "tabler:list-filled"
  | "tabler:list-letters"
  | "tabler:list-numbers"
  | "tabler:list-search"
  ...
  | "tabler:mood-check"
  | "tabler:mood-cog"
  | "tabler:mood-confused"
  | "tabler:mood-confused-filled"
  ...
  | "tabler:phone"
  | "tabler:phone-call"
  | "tabler:phone-call-filled"
  | "tabler:phone-calling"
  | "tabler:phone-calling-filled"
  | "tabler:phone-check"
  | "tabler:phone-check-filled"
  | "tabler:phone-done"
  | "tabler:phone-end"
  | "tabler:phone-filled"
  ...
  | "tabler:plane-arrival-filled"
  | "tabler:plane-departure"
  | "tabler:plane-departure-filled"
  | "tabler:plane-filled"
  | "tabler:plane-inflight"
  | "tabler:plane-off"
  | "tabler:plane-tilt"
  | "tabler:plane-tilt-filled"
  | "tabler:planet"
  | "tabler:planet-off"
  | "tabler:plant"
  | "tabler:plant-2"
  ...
  | "tabler:pointer-code"
  | "tabler:pointer-cog"
  | "tabler:pointer-collaboration"
  | "tabler:pointer-collaboration-2"
  ...
  | "tabler:report-analytics-filled"
  | "tabler:report-medical"
  | "tabler:report-money"
  | "tabler:report-money-filled"
  | "tabler:report-off"
  ...
  | "tabler:scan-cube"
  | "tabler:scan-eye"
  | "tabler:scan-letter-a"
  | "tabler:scan-letter-t"
  ...
  | "tabler:sparkle"
  | "tabler:sparkle-2"
  | "tabler:sparkle-highlight"
  | "tabler:sparkles"
  | "tabler:sparkles-2"
  | "tabler:sparkles-2-filled"
  | "tabler:sparkles-2-off"
  | "tabler:sparkles-filled"
  | "tabler:speakerphone"
  | "tabler:speedboat"
  ...
  | "tabler:tag-starred"
  | "tabler:tags"
  | "tabler:tags-chevron-down"
  | "tabler:tags-chevron-left"
  | "tabler:tags-chevron-right"
  | "tabler:tags-chevron-up"
  | "tabler:tags-filled"
  | "tabler:tags-off"
  | "tabler:taiwan-dollar"
  | "tabler:tallymark-1"
  | "tabler:tallymark-2"
  | "tabler:tallymark-3"
  | "tabler:tallymark-4"
  ...
  | "tabler:text-regex-asterisk"
  | "tabler:text-regex-end"
  | "tabler:text-regex-plus"
  | "tabler:text-regex-question"
  | "tabler:text-regex-start"
  | "tabler:text-resize"
  | "tabler:text-scan-2"
  | "tabler:text-scan-ai"
  | "tabler:text-size"
  ...
  | "tabler:theater"
  | "tabler:thermometer"
  | "tabler:thinking-high"
  | "tabler:thinking-low"
  | "tabler:thinking-medium"
  | "tabler:thumb-down"
